...
Module {
    ...
    property stringList config: ["shared","debug_and_release","debug","release","build_all","c++11","c++14","c++1z","concurrent","dbus","no-pkg-config","stl"]
    property stringList qtConfig: ["shared","debug_and_release","debug","release","build_all","c++11","c++14","c++1z","concurrent","dbus","no-pkg-config","stl"]
    property path binPath: "C:/Qt/5.13.2/mingw73_64/bin"
    property path incPath: "C:/Qt/5.13.2/mingw73_64/include"
    property path libPath: "C:/Qt/5.13.2/mingw73_64/lib"
    property path pluginPath: "C:/Qt/5.13.2/mingw73_64/plugins"
    property string mkspecName: "win32-g++"
    property path mkspecPath: "C:/Qt/5.13.2/mingw73_64/mkspecs/win32-g++"
    ...
    property path docPath: "C:/Qt/Docs/Qt-5.13.2"
    ...
    property string libNameForLinkerDebug: "Qt5Cored"
    ...
    property string libFilePathDebug: "C:/Qt/5.13.2/mingw73_64/lib/libQt5Cored.a"
    property string libFilePathRelease: "C:/Qt/5.13.2/mingw73_64/lib/libQt5Core.a"
    ...
    property stringList moduleConfig: ["lex","yacc","exceptions","depend_includepath","testcase_targets","import_plugins","import_qpa_plugin","windows","qt_build_extra","file_copies","qmake_use","qt","warn_on","release","link_prl","debug_and_release","precompile_header","shared","release","no_plugin_manifest","win32","mingw","gcc","copy_dir_files","sse2","aesni","sse3","ssse3","sse4_1","sse4_2","compile_examples","largefile","optimize_debug","precompile_header","rdrnd","shani","x86SimdAlways","prefix_build","force_independent","utf8_source","create_prl","link_prl","prepare_docs","qt_docs_targets","no_private_qt_headers_warning","QTDIR_build","qt_example_installs","testcase_exceptions","warning_clean","release","ReleaseBuild","Release","build_pass","exceptions","qt_tracepoints","moc","resources","simd","optimize_full","pcre2","generated_privates","relative_qt_rpath","git_build","qmake_cache","target_qt","c++11","strict_c++","c++14","c++1z","c99","c11","qt_install_headers","need_fwd_pri","qt_install_module","debug_and_release","build_all","create_cmake","skip_target_version_ext","compiler_supports_fpmath","create_pc","release","ReleaseBuild","Release","build_pass","have_target","dll","exclusive_builds","no_autoqmake","thread"]
    Properties {
    ...
    cpp.includePaths: {
        var paths = ["C:/Qt/5.13.2/mingw73_64/include","C:/Qt/5.13.2/mingw73_64/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["C:/Qt/5.13.2/mingw73_64/lib/libqtmaind.a"] : ["C:/Qt/5.13.2/mingw73_64/lib/libqtmain.a"]);
        }
